...
const PickUpSlots = ({ availableSlots = [], onSlotChange,orderTypeId }) => {
    console.log("orderTypeId",orderTypeId);
    console.log("pickupslots",availableSlots)
    ...
    <View style={styles.container}>
      ...
      {selectedDeliveryDate && availableSlotsForSelectedDate.length > 0 ? (
        <ScrollView contentContainerStyle={styles.slotContainer}>
          {availableSlotsForSelectedDate.filter(s=> s.slotType == 1).map((slot) => {
